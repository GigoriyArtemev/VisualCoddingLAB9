...
using VisualCoddingLAB9.Models;
using ReactiveUI;
using System;
...
namespace VisualCoddingLAB9.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        #region FIELDS

        private DirectoryTree? __rootDirectory;
        ...
        public HierarchicalTreeDataGridSource<DirectoryTree> Source { get; }
        ...
        public MainWindowViewModel()
        {
            ...
            Source = new HierarchicalTreeDataGridSource<DirectoryTree>(Array.Empty<DirectoryTree>())
            {
                Columns =
                {
                    new HierarchicalExpanderColumn<DirectoryTree>(
                        new TemplateColumn<DirectoryTree>(
                            "Explorer",
                            new FuncDataTemplate<DirectoryTree>(FileNameTemplate, true),
            ...
            this.WhenAnyValue(x => x.SelectedLogicalDrive)
                .Subscribe(x =>
                {
                    __rootDirectory = new DirectoryTree(__selectedLogicalDrive, isRoot: true);
        ...
        private IControl FileNameTemplate(DirectoryTree node, INameScope ns)
        {
            return new StackPanel
            {
                ...
                Children =
                {
                    ...
                    new TextBlock
                    {
                        [!TextBlock.TextProperty] = new Binding(nameof(DirectoryTree.Name)),
                        VerticalAlignment = VerticalAlignment.Center,
                    }
                }
            };
        ...
        private void SetSelectedPath(string? value)
        {
            ...
            if (components.Count > 0)
            {
                ...
                DirectoryTree? node = __rootDirectory;
        ...
        private void SelectionChanged(object? sender, TreeSelectionModelSelectionChangedEventArgs<DirectoryTree> e)
        {
